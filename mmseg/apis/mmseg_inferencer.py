...
class MMSegInferencer(BaseInferencer):
    """Semantic segmentation inferencer, provides inference and hooks
    ...
    def __call__(self,
        ...
        Returns:
            dict: Inference and hooks results.
        """
    ...
    def postprocess(self,
        ...
        """Process the predictions and hooks results from ``forward``
        and ``visualize``.

        This method should be responsible for the following tasks:

        1. Pack the predictions and hooks results and return them.
        ...
        Args:
            ...
            pred_out_dir: File to save the inference results w/o
                hooks. If left as empty, no file will be saved.
                Defaults to ''.

        Returns:
            dict: Inference and hooks results with key ``predictions``
            and ``hooks``

            - ``hooks (Any)``: Returned by :meth:`visualize`
