...
class ResNet(BaseModule):
    ...
    def __init__(self,
        ...
        self.stem_out_indices=stem_out_indices
        self.style = style
        ...
        self._make_stem_layer(in_channels, stem_channels,stem_stride)
    ...
    def _make_stem_layer(self, in_channels, stem_channels,stem_stride):
        ...
        if self.deep_stem:
            ...
            self.add_module(self.norm1_name, norm1)
            self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=stem_stride[1], padding=1)
...
class ResNetV1c(ResNet):
    ...
    def __init__(self, **kwargs):
        super().__init__( avg_down=False, **kwargs)
...
class ResNetV1d(ResNet):
    ...
    def __init__(self, **kwargs):
        super().__init__(avg_down=True, **kwargs)
